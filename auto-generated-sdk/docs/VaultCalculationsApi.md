...
> {str: (bool, date, datetime, dict, float, int, list, str, none_type)} get_vault_calculation_by_id(id)
...
> {str: (bool, date, datetime, dict, float, int, list, str, none_type)} run_vault_calculation()
...
with fds.analyticsapi.engines.ApiClient(configuration) as api_client:
    ...
    vault_calculation_parameters = VaultCalculationParameters(
    ...
    ) # VaultCalculationParameters |  (optional)
