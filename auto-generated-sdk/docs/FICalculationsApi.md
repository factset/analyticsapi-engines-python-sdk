...
# **run_fi_calculation**
> object run_fi_calculation(fi_calculation_parameters=fi_calculation_parameters)
...
with fds.analyticsapi.engines.ApiClient(configuration) as api_client:
    ...
    try:
        # Run FI calculation
        api_response = api_instance.run_fi_calculation(fi_calculation_parameters=fi_calculation_parameters)
        pprint(api_response)
    except ApiException as e:
