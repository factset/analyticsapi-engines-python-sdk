...
class LinkedPATemplateUpdateParametersObjectDataAndMetaModel(ModelNormal):
    ...
    def __init__(self, data, *args, **kwargs):  # noqa: E501
        """LinkedPATemplateUpdateParametersObjectDataAndMetaModel - a model defined in OpenAPI
