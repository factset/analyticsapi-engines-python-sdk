...
class StringComponentSummaryDictionaryObjectDataAndMetaModel(ModelNormal):
    ...
    def __init__(self, data, *args, **kwargs):  # noqa: E501
        """StringComponentSummaryDictionaryObjectDataAndMetaModel - a model defined in OpenAPI
