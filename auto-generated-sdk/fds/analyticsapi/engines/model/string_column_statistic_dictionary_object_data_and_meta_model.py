...
class StringColumnStatisticDictionaryObjectDataAndMetaModel(ModelNormal):
    ...
    def __init__(self, data, *args, **kwargs):  # noqa: E501
        """StringColumnStatisticDictionaryObjectDataAndMetaModel - a model defined in OpenAPI
