...
class CalculationStatusCalculationStatusMetaDataAndMetaModel(ModelNormal):
    ...
    def __init__(self, data, *args, **kwargs):  # noqa: E501
        """CalculationStatusCalculationStatusMetaDataAndMetaModel - a model defined in OpenAPI
