...
class TemplatedPAComponentUpdateParametersObjectDataAndMetaModel(ModelNormal):
    ...
    def __init__(self, data, *args, **kwargs):  # noqa: E501
        """TemplatedPAComponentUpdateParametersObjectDataAndMetaModel - a model defined in OpenAPI
