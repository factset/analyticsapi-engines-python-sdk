...
class PACalculationParametersCalculationMetaCalculationParameters(ModelNormal):
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        """PACalculationParametersCalculationMetaCalculationParameters - a model defined in OpenAPI
