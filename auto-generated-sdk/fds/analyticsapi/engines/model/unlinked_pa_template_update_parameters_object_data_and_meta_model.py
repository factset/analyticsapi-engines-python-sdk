...
class UnlinkedPATemplateUpdateParametersObjectDataAndMetaModel(ModelNormal):
    ...
    def __init__(self, data, *args, **kwargs):  # noqa: E501
        """UnlinkedPATemplateUpdateParametersObjectDataAndMetaModel - a model defined in OpenAPI
