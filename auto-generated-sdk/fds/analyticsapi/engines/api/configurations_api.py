...
class ConfigurationsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __get_pa_commentary_configurations(
            self,
            path,
            **kwargs
        ):
            ...
            >>> thread = api.get_pa_commentary_configurations(path, async_req=True)
            >>> result = thread.get()
        ...
        self.get_pa_commentary_configurations = _Endpoint(
            settings={
                'response_type': dict({ 200:(PACommentaryConfigurationSummaryRoot,),  }),
                'auth': [
                    'Basic',
                    'Bearer'
                ],
            ...
            callable=__get_pa_commentary_configurations
        )
