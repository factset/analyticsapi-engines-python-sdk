    ...
    def __init__(self, api_client=None):
        ...
        def __generate_pa_portfolio_commentary(
            ...
            **kwargs
            ...
            >>> thread = api.generate_pa_portfolio_commentary(id, unit_id, async_req=True)
            >>> result = thread.get()
            ...
            Returns:
                (For 201 status - PACommentaryRoot)(For 202 status - PACommentaryGetStatusRoot)
                    If the method is called asynchronously, returns the request
                    thread.
            """
            kwargs['async_req'] = kwargs.get(
        ...
        self.generate_pa_portfolio_commentary = _Endpoint(
            settings={
                'response_type': dict({ 201:(PACommentaryRoot,), 202:(PACommentaryGetStatusRoot,),  }),
                'auth': [
                    'Basic',
                    'Bearer'
                ],
            ...
            api_client=api_client,
            callable=__generate_pa_portfolio_commentary
        )
        ...
        def __get_pa_portfolio_commentary_result_by_id(
            self,
            id,
            unit_id,
            **kwargs
            ...
            >>> thread = api.get_pa_portfolio_commentary_result_by_id(id, unit_id, async_req=True)
            >>> result = thread.get()
        ...
        self.get_pa_portfolio_commentary_result_by_id = _Endpoint(
            settings={
                'response_type': dict({ 200:(PACommentaryRoot,),  }),
                'auth': [
                    'Basic',
                    'Bearer'
                ],
            ...
            api_client=api_client,
            callable=__get_pa_portfolio_commentary_result_by_id
        )

        def __get_pa_portfolio_commentary_status_by_id(
            self,
            id,
            unit_id,
            **kwargs
            ...
            >>> thread = api.get_pa_portfolio_commentary_status_by_id(id, unit_id, async_req=True)
            >>> result = thread.get()
            ...
            Returns:
                (For 200 status - PACommentaryStatusRoot)(For 202 status - PACommentaryGetStatusRoot)
                    If the method is called asynchronously, returns the request
                    thread.
            """
            kwargs['async_req'] = kwargs.get(
        ...
        self.get_pa_portfolio_commentary_status_by_id = _Endpoint(
            settings={
                'response_type': dict({ 200:(PACommentaryStatusRoot,), 202:(PACommentaryGetStatusRoot,),  }),
                'auth': [
                    'Basic',
                    'Bearer'
                ],
            ...
            api_client=api_client,
            callable=__get_pa_portfolio_commentary_status_by_id
        )
