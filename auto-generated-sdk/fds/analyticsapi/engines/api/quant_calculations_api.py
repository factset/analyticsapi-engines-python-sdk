    ...
    def __init__(self, api_client=None):
        ...
        def __post_and_calculate(
            ...
            **kwargs
            ...
            Keyword Args:
                ...
                quant_calculation_parameters_quant_calculation_meta_calculation_parameters (QuantCalculationParametersQuantCalculationMetaCalculationParameters): [optional]
                _return_http_data_only (bool): response data without head status
                    code and headers. Default is False.
                _preload_content (bool): if False, the urllib3.HTTPResponse object
                    will be returned without reading/decoding response data.
        ...
        self.post_and_calculate = _Endpoint(
            ...
            params_map={
                'all': [
                    'cache_control',
                    'quant_calculation_parameters_quant_calculation_meta_calculation_parameters',
                ],
                'required': [],
                'nullable': [
                ],
            ...
            root_map={
                ...
                'location_map': {
                    ...
                    'quant_calculation_parameters_quant_calculation_meta_calculation_parameters': 'body',
                },
                'collection_format_map': {
                }
            },
        ...
        def __put_and_calculate(
            ...
            **kwargs
            ...
            Keyword Args:
                cache_control (str): Standard HTTP header.  Accepts no-store, max-age, max-stale.. [optional]
                quant_calculation_parameters_quant_calculation_meta_calculation_parameters (QuantCalculationParametersQuantCalculationMetaCalculationParameters): Calculation Parameters. [optional]
                _return_http_data_only (bool): response data without head status
                    code and headers. Default is False.
                _preload_content (bool): if False, the urllib3.HTTPResponse object
                    will be returned without reading/decoding response data.
