...
class FIABCalculationsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __get_fiab_calculation_by_id(
            self,
            id,
            **kwargs
        ):
        ...
        self.get_fiab_calculation_by_id = _Endpoint(
            settings={
            ...
            callable=__get_fiab_calculation_by_id
        )

        def __get_fiab_calculation_status_summaries(
            self,
            **kwargs
        ):
        ...
        self.get_fiab_calculation_status_summaries = _Endpoint(
            settings={
            ...
            api_client=api_client,
            callable=__get_fiab_calculation_status_summaries
        )

        def __run_fiab_calculation(
            self,
            **kwargs
        ):
        ...
        self.run_fiab_calculation = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'Basic'
            ...
            api_client=api_client,
            callable=__run_fiab_calculation
        )
