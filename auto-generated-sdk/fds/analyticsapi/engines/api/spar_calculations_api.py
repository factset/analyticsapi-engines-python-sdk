...
class SPARCalculationsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __cancel_spar_calculation_by_id(
            self,
            id,
            **kwargs
        ):
        ...
        self.cancel_spar_calculation_by_id = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'Basic'
                ],
                'endpoint_path': '/analytics/engines/spar/v2/calculations/{id}',
                'operation_id': 'cancel_spar_calculation_by_id',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
            ...
            callable=__cancel_spar_calculation_by_id
        )

        def __get_spar_calculation_by_id(
            self,
            id,
            **kwargs
        ):
        ...
        self.get_spar_calculation_by_id = _Endpoint(
            settings={
                ...
                'endpoint_path': '/analytics/engines/spar/v2/calculations/{id}',
                'operation_id': 'get_spar_calculation_by_id',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__get_spar_calculation_by_id
        )

        def __run_spar_calculation(
            self,
            **kwargs
        ):
            ...
            Keyword Args:
                ...
                spar_calculation_parameters (SPARCalculationParameters): [optional]
                _return_http_data_only (bool): response data without head status
                    code and headers. Default is True.
                _preload_content (bool): if False, the urllib3.HTTPResponse object
                    will be returned without reading/decoding response data.
        ...
        self.run_spar_calculation = _Endpoint(
            settings={
                'response_type': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},),
                'auth': [
                    'Basic'
                ],
                'endpoint_path': '/analytics/engines/spar/v2/calculations',
                'operation_id': 'run_spar_calculation',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            root_map={
                ...
                'location_map': {
                    ...
                    'spar_calculation_parameters': 'body',
                },
                'collection_format_map': {
                }
            },
            ...
            api_client=api_client,
            callable=__run_spar_calculation
        )
