...
class SPARCalculationsApi(object):
    ...
    def cancel_calculation_by_id(self, id, **kwargs):  # noqa: E501
        ...
        :param str id: from url, provided from the location header in the Create and Run SPAR calculation endpoint (required)
    ...
    def get_calculation_parameters_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(SPARCalculationParametersRoot, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='SPARCalculationParametersRoot',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
    ...
    def get_calculation_unit_result_by_id(self, id, unit_id, **kwargs):  # noqa: E501
        ...
        :param async_req bool: execute request asynchronously
        :param str id: from url, provided from the location header in the Get SPAR calculation status by id endpoint (required)
        :param str unit_id: from url, provided from the location header in the Get SPAR calculation status by id endpoint (required)
    ...
    def post_and_calculate(self, **kwargs):  # noqa: E501
        ...
        :param SPARCalculationParametersRoot spar_calculation_parameters_root: Calculation Parameters
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
    ...
    def post_and_calculate_with_http_info(self, **kwargs):  # noqa: E501
        ...
        body_params = None
        if 'spar_calculation_parameters_root' in local_var_params:
            body_params = local_var_params['spar_calculation_parameters_root']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json', 'application/x-protobuf'])  # noqa: E501
