...
class VaultCalculationsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __cancel_vault_calculation_by_id(
            self,
            id,
            **kwargs
        ):
        ...
        self.cancel_vault_calculation_by_id = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'Basic'
                ],
                'endpoint_path': '/analytics/engines/vault/v2/calculations/{id}',
                'operation_id': 'cancel_vault_calculation_by_id',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
            ...
            callable=__cancel_vault_calculation_by_id
        )

        def __get_vault_calculation_by_id(
            self,
            id,
            **kwargs
        ):
        ...
        self.get_vault_calculation_by_id = _Endpoint(
            settings={
                ...
                'endpoint_path': '/analytics/engines/vault/v2/calculations/{id}',
                'operation_id': 'get_vault_calculation_by_id',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__get_vault_calculation_by_id
        )

        def __run_vault_calculation(
            self,
            **kwargs
        ):
            ...
            Keyword Args:
                ...
                vault_calculation_parameters (VaultCalculationParameters): [optional]
                _return_http_data_only (bool): response data without head status
                    code and headers. Default is True.
                _preload_content (bool): if False, the urllib3.HTTPResponse object
                    will be returned without reading/decoding response data.
        ...
        self.run_vault_calculation = _Endpoint(
            settings={
                'response_type': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},),
                'auth': [
                    'Basic'
                ],
                'endpoint_path': '/analytics/engines/vault/v2/calculations',
                'operation_id': 'run_vault_calculation',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            root_map={
                ...
                'location_map': {
                    ...
                    'vault_calculation_parameters': 'body',
                },
                'collection_format_map': {
                }
            },
            ...
            api_client=api_client,
            callable=__run_vault_calculation
        )
