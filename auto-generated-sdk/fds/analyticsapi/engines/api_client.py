...
from fds.analyticsapi.engines.exceptions import ApiTypeError, ApiValueError, ApiException
from fds.analyticsapi.engines.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'engines-api/5.7.0-rc.1/python'
