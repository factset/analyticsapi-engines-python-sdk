# fds.analyticsapi.engines.v2.ConfigurationsApi
...
> VaultConfiguration get_vault_configuration_by_id(id)
...
api_instance = fds.analyticsapi.engines.v2.ConfigurationsApi(fds.analyticsapi.engines.v2.ApiClient(configuration))
...
> dict(str, VaultConfigurationSummary) get_vault_configurations(account)
...
[**dict(str, VaultConfigurationSummary)**](VaultConfigurationSummary.md)
