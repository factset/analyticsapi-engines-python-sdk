# fds.analyticsapi.engines.v2.CalculationsApi
...
api_instance = fds.analyticsapi.engines.v2.CalculationsApi(fds.analyticsapi.engines.v2.ApiClient(configuration))
...
# Create an instance of the API class
api_instance = fds.analyticsapi.engines.v2.CalculationsApi(fds.analyticsapi.engines.v2.ApiClient(configuration))
calculation = fds.analyticsapi.engines.v2.Calculation() # Calculation |  (optional)
