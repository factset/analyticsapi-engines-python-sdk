# fds.analyticsapi.engines.v2.CurrenciesApi
...
# **get_pa_currencies**
> dict(str, Currency) get_pa_currencies()
...
api_instance = fds.analyticsapi.engines.v2.CurrenciesApi(fds.analyticsapi.engines.v2.ApiClient(configuration))
