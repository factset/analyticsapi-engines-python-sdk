# fds.analyticsapi.engines.v2.ComponentsApi
...
> PAComponent get_pa_component_by_id(id)
...
api_instance = fds.analyticsapi.engines.v2.ComponentsApi(fds.analyticsapi.engines.v2.ApiClient(configuration))
...
> VaultComponent get_vault_component_by_id(id)
