...
class TestCurrenciesApi(unittest.TestCase):
    ...
    def test_get_all_currencies(self):
        response = self.currencies_api.get_currencies(_return_http_data_only=False)
        ...
        self.assertEqual(type(response[0].data[currency_code]), Currency, "Response should be of Currency type.")
